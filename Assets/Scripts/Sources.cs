...
public class Sources : MonoBehaviour
{
    ...
    String[] sourceLinks = new String[] {
        "https://graphicriver.net/item/animal-pets-grooming-and-healthcare-flat-colorful-vector-icons/14484763> Test </link>", 
    ...
    private GameObject SpawnSource(int sourceIndex) {
        ...
        source.transform.position = new Vector3(900, -200, -1);
